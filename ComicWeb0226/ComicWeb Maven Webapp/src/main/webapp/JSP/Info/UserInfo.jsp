...
<html>
  ...
  <body>
			...
			<section>
				...
				<nav>   
					<label for="profile" class='fontawesome-camera-retro' onclick="tab('userinfo/info/${userid}')"></label>
					<label for="settings" class='fontawesome-film'  onclick="tab('userinfo/lovecomic/${userid}')"></label>
					<label for="posts" class='fontawesome-calendar'  onclick="tab('userinfo/lovecomicer/${userid}')"></label>
					<label for="books" class='fontawesome-list-alt'  onclick="tab('userinfo/comment/${userid}')"></label>
				</nav>
