				...
				<c:forEach items="${comics}" var="comic">
					<div class="authorComic">
						...
						<div class="comicOperation">
							<a onclick="ModifyComic('${comic.comicId}')"  class="buttonBlue">信息更改</a>
							<a  onclick="ModifyComicPart('${comic.comicId}')"  class="buttonRed">章节更改</a>
						</div>
					</div>
				</c:forEach>
			</div>
...
<script type="text/javascript">
	function ModifyComic(id){
		var urlStr="<%=request.getContextPath()%>/author/modifycomic";	
		urlStr+="/"+id;
		$.ajax({
			url : urlStr,
			async : false,
	...
	function ModifyComicPart(id){
		var urlStr="<%=request.getContextPath()%>/author/modifycomicpart";	
		urlStr+="/"+id;
		$.ajax({
			url : urlStr,
			async : false,
	...
	function SelectedPage() {
		var urlStr="<%=request.getContextPath()%>/author/comicmanage";	
